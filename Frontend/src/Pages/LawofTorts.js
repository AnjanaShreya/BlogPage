...
const LawofTorts = () => {
  ...
  return (
    <div>
      ...
      <CategoryHeading title="Law of Torts" />
      ...
      <div className="flex flex-wrap justify-center min-h-20 py-5">
        {blogData.length > 0 ? (
          ...
          <div className="w-full text-center text-gray-500">No blogs found related to the Law of Torts</div>
        )}
      </div>
      <Footer />
    </div>
